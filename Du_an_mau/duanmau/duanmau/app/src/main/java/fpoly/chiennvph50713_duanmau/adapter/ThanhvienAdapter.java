...
import fpoly.chiennvph50713_duanmau.dao.ThanhvienDAO;
import fpoly.chiennvph50713_duanmau.model.Thanhvien;
...
public class ThanhvienAdapter extends RecyclerView.Adapter<ThanhvienAdapter.viewHolder> implements Filterable {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(fpoly.chiennvph50713_duanmau.R.layout.item_thanhvien, parent, false);
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.txt_stkTV.setText(String.valueOf(list_TV.get(position).getStk()));
        //Hiển thị giới tính
        String gioitinh = "";
        if (list_TV.get(position).getGioitinh()== 0 ){
            gioitinh = "Nam";
        } else {
            gioitinh = "Nữ";
            holder.txt_gioitinhTV.setTextColor(Color.YELLOW);
        }
        holder.txt_gioitinhTV.setText(gioitinh);

        //hiển thị in đậm nếu như chia hết cho 5
        if (list_TV.get(position).getStk() % 5 ==0){
            holder.txt_stkTV.setTypeface(null, Typeface.BOLD);
        } else {
            holder.txt_stkTV.setTypeface(null, Typeface.NORMAL);
        }
    ...
    private void capnhatTV(int position) {
        ...
        EditText edt_stkTV = view.findViewById(R.id.edt_stkTV02);
        ...
        edt_stkTV.setText(list_TV.get(position).getStk());
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        TextView txt_idTV, txt_nameTV, txt_namsinhTV,txt_gioitinhTV,txt_stkTV;
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            txt_gioitinhTV = itemView.findViewById(R.id.txt_gioitinhTV);
            txt_stkTV = itemView.findViewById(R.id.txt_stkTV);
