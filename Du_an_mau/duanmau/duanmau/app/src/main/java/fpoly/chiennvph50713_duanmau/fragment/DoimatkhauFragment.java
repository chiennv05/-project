...
import fpoly.chiennvph50713_duanmau.activity.LoginActivity;
import fpoly.chiennvph50713_duanmau.dao.ThuthuDAO;
...
public class DoimatkhauFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(fpoly.chiennvph50713_duanmau.R.layout.fragment_doimatkhau, container, false);
        ...
        btn_doiMK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (oldPass.isEmpty() || newPass.isEmpty() || rePass.isEmpty()) {
                    ...
                    } else if (newPass.length() < 6 || newPass.length() > 25) {
                        Toast.makeText(getContext(), "Mật khẩu phải hơn 6 kí tự", Toast.LENGTH_SHORT).show();
                    } else {
