...
public class PhieumuonDAO {
    ...
    public ArrayList<Phieumuon> dsPhieumuon() {
        ...
        String truyvan = "SELECT pm.mapm,pm.matv,tv.hoten,pm.matt,tt.hotentt,pm.masach,sc.tensach,pm.ngay,pm.trasach,pm.tienthue,pm.gio FROM PHIEUMUON pm , THANHVIEN tv, THUTHU tt, SACH sc WHERE pm.matv = tv.matv AND pm.matt = tt.matt AND pm.masach = sc.masach";
        ...
        if (ketqua.getCount() > 0) {
            if (ketqua.moveToFirst()) {
                do {
                    ...
                    phieumuon.setGio(ketqua.getString(10));
